...
return [
    ...
    | por la clase Validator de Laravel. Algunas reglas tienen múltiples
    | versiones, como las de tamaño (size). Podés modificar estos mensajes
    | libremente según las necesidades de tu aplicación.
    |
    */
    ...
    'password'             => [
        ...
        'uncompromised' => 'El valor ingresado para :attribute aparece en una filtración de datos conocida. Elegí otro :attribute.',
    ],
    ...
    | atributo y regla, usando la convención "atributo.regla" para nombrar
    | las líneas. Esto permite tener un mensaje específico para una regla
    | de validación en un campo puntual de tu aplicación.
    |
    */

    'custom' => [
        'phone' => [
            'regex' => 'El teléfono debe comenzar con +54 y no debe contener espacios.',
        ],
        'reservation_time' => [
            'after' => 'La hora debe ser posterior a la actual.',
        ],
        'reservation_date' => [
            'after_or_equal' => 'La fecha no puede ser anterior a hoy.',
        ],
        'shipping_address' => [
            'required_if' => 'Ingresá la dirección de envío.',
        ],
    ],
    ...
    | por algo más legible, como "Dirección de correo electrónico" en vez
    | de "email". Esto ayuda a que los mensajes sean más claros para el
    ...
    */
    ...
    'attributes' => [
        ...
        'transfer_reference'    => 'número de operación',
        'receipt'               => 'comprobante',
    ],
