...
@section('title', 'Editar Perfil de Negocio | ProyectoUTN')
...
<div class="max-w-2xl mx-auto py-8">
    <div class="border border-slate-800 bg-slate-900/40 backdrop-blur rounded-2xl p-8 shadow-xl">
        ...
        <p class="text-slate-400 mt-2 text-sm">
            Responsable: <span class="text-indigo-300 font-semibold">Programador 1</span> | Modelo: <code>BusinessProfile</code>
        </p>

        <!-- Form placeholder -->
        <div class="mt-8 border border-dashed border-slate-800 rounded-xl p-8 text-center text-slate-500 text-sm">
            <p>Aquí se maquetará el formulario de edición de datos comerciales (Nombre del negocio, descripción, teléfono, dirección y subida de logo).</p>
        </div>
    </div>
</div>
@endsection
