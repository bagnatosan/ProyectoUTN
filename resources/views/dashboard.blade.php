...
<div class="max-w-2xl mx-auto text-center animate-fade-in py-12">
    ...
    <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight mt-6 text-white">
        ...
        <span class="bg-gradient-to-r
            @if(auth()->user()->role === 'admin') from-purple-400 to-pink-400
            @elseif(auth()->user()->role === 'seller') from-purple-400 to-pink-400
            @else from-indigo-400 to-cyan-400
            @endif
