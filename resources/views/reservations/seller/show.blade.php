...
<style>
  ...
  :root {
    ...
    --sd-primary: #22c55e;
    --sd-primary-dim: rgba(34, 197, 94, 0.1);
    --sd-warning: #eab308;
    --sd-warning-dim: rgba(234, 179, 8, 0.1);
    --sd-info: #38bdf8;
    --sd-info-dim: rgba(56, 189, 248, 0.1);
    --sd-success: #4ade80;
    --sd-success-dim: rgba(74, 222, 128, 0.1);
    --sd-danger: #f43f5e;
    --sd-danger-dim: rgba(244, 63, 94, 0.1);
    --sd-input-bg: #0f172a;
    --sd-radius: 1rem;
